...
static int convert_to_bidiag_cn(const int Nrows,const int Ncols,double *U,double *V,double *diag,double *superdiag);
static int bidiag_to_diag_cn(const int Nrows,const int Ncols,double *U,double *V,double *diag,double *superdiag);
static int sort_singular_values_cn(const int Nrows,const int Ncols,double *U,double *V,double *singular_values);
...
int svd(double const*  A,
        ...
        double*        superdiag)
{
  int status, row, col, rows1, cols1;
  ...
  if (rows >= cols) {
    rows1 = rows;
    cols1 = cols;
    memcpy(U, A, sizeof(double) * rows * cols);
  } else {
  ...
  /* ------------------------------------------------------------------- */
  convert_to_bidiag_cn(rows1 , cols1, U, V, diag, superdiag);

  /* ------------------------------------------------------------------- */
  /* convert bidiagonal to diagonal using Givens rotations               */
  /* ------------------------------------------------------------------- */
  status=bidiag_to_diag_cn(rows1, cols1, U, V, diag, superdiag);

  /* ------------------------------------------------------------------- */
  /* sort singular values in descending order                            */
  /* ------------------------------------------------------------------- */
  sort_singular_values_cn(rows1, cols1, U, V, diag);
...
#else
    memcpy(U1, V,  sizeof(double) * cols * cols);
    memcpy(V,  U,  sizeof(double) * rows * cols);
    memcpy(U,  U1, sizeof(double) * rows * cols);
#endif
  }
...
int convert_to_bidiag_cn(const int Nrows,const int Ncols,double *U,double *V,double *diag,double *superdiag)
{
  int i,j,k;
...
int bidiag_to_diag_cn(const int Nrows,const int Ncols,double *U,double *V,double *diag,double *superdiag)
{
...
int sort_singular_values_cn(const int Nrows,const int Ncols,double *U,double *V,double *singular_values)
{
